...
// 使用例
const ExamplePage = () => {
  // 2. データ構造を修正し、元のデータ内容を維持
  const segments: Segment[] = [
    { start: "00:00", end: "06:00", className: "fill-red-400 dark:fill-red-600" },
    { start: "06:00", end: "12:00", className: "fill-orange-400 dark:fill-orange-600" },
    { start: "12:00", end: "18:00", className: "fill-green-400 dark:fill-green-600" },
    { start: "18:00", end: "24:00", className: "fill-blue-400 dark:fill-blue-600" },
  ];

  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-900">
      <DonutChart segments={segments} size={500} innerRadius={0.8} />
    </div>
  );
};
